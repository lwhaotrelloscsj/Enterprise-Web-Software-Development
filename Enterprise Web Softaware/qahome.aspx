<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qahome.aspx.cs" Inherits="Enterprise_Web_Softaware.qahome" %>
...
<body>
    ...
    <nav>
         ...
         <ul>
            <li><a class="active" href="qahome.aspx">Home</a></li>
                <li><a href="qadashboard.aspx">Dashboard</a></li>
                <li><a href="qacategory.aspx">Categories</a></li>
                <li><a href="qaprofile.aspx">Profile</a></li>
...
<div class="panel">
    <div class="panel-body">  
        <div class="flex-container">
            <div><a id="latestPost" runat="server" href="qahome.aspx"><img src="Images/picture.png"/>Latest Ideas</a></div>
            <div><a id="mostLike" runat="server" href="qapopular.aspx" ><img src="Images/like.png"/>Most Popular Ideas</a></div>
            <div><a id="mostComment" runat="server" href="qacomment.aspx" ><img src="Images/bubble-chat.png"/>Most Comment Ideas</a></div>
            <div class="dropdown">
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="media-block">
                    ...
                    <asp:label runat="server" id="postRegId" style="display:none;"><%# Eval("postregID") %></asp:label>
                    <div class="dropdown media-right">  
                        <button <%# (int)Eval("postregID") == Convert.ToInt32(Session["userID"]) ? "" : "style='display:none'" %> class="btn btn-default dropdown-toggle" id="optionButton" type="button" data-toggle="dropdown">&#8226;&#8226;&#8226;</button>
                        <div class="dropdown-menu" aria-labelledby="optionButton">
                          <asp:LinkButton class="dropdown-item" runat="server" CommandArgument='<%# Eval("postID") %>' OnClick="delete_Click">Delete Post</asp:LinkButton>
                        </div>
                    </div>
