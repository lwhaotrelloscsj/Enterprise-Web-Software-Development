<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="managerhome.aspx.cs" Inherits="Enterprise_Web_Softaware.managerhome" %>
...
<body>
    ...
    <nav>
        <div class="logo">Scrumlight Idea</div>
            ...
            <ul>
                <li><a class="active" href="managerhome.aspx">Home</a></li>
...
<div class="panel">
    <div class="panel-body">  
        <div class="flex-container">
            <div><a id="latestPost" runat="server" href="managerhome.aspx"><img src="Images/picture.png"/>Latest Ideas</a></div>
            <div><a id="mostLike" runat="server" href="managerpopular.aspx"><img src="Images/like.png"/>Most Popular Ideas</a></div>
            <div><a id="mostComment" runat="server" href="managercomment.aspx"><img src="Images/bubble-chat.png"/>Most Comment Ideas</a></div>
            <div class="dropdown">
