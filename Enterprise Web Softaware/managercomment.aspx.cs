...
{
    public partial class managercomment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string sqlstring = "SELECT Posts.*, Register.regPosition, Register.regPosition, Register.regUsername, " +
                ...
                "WHERE Posts.postID IN (SELECT TOP 25 commentpostID FROM Comments GROUP BY commentpostID ORDER BY COUNT(*) DESC) AND Posts.postClosed = 0 " +
        ...
        protected void delete_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("managercomment.aspx");
        }
