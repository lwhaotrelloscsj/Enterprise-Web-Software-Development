<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qadashboard.aspx.cs" Inherits="Enterprise_Web_Softaware.qadashboard" %>
...
<body>
    ...
    <nav>
         ...
         <ul>
            ...
            <li><a class="active" href="qadashboard.aspx">Dashboard</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 p-2">
            <div class="card border-primary rounded-0">
              <div class="card-header bg-primary rounded-0">
                <h5 class="card-title text-white mb-1">Total Comment of category</h5>
              </div>
              <div class="card-body">
