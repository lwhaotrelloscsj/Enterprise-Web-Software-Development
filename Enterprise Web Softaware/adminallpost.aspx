<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminallpost.aspx.cs" Inherits="Enterprise_Web_Softaware.adminallpost" %>
...
<body>
    <div>
    <nav>
        <div class="logo">Scrumlight Idea</div>
            <input type="checkbox" id="click" style="display:none;"/>
            <label for="click" class="menu-btn">
                <i class="fas fa-bars"></i>
            </label>
            <ul>
                <li><a class="active" href="adminallpost.aspx">Home</a></li>
...
<div class="panel">
    <div class="panel-body">  
        <div class="flex-container">
            <div><a id="latestPost" runat="server" href="adminallpost.aspx"><img src="Images/picture.png"/>Latest Ideas</a></div>
            <div><a id="mostLike" runat="server" href="adminpopular.aspx"><img src="Images/like.png"/>Most Popular Ideas</a></div>
            <div><a id="mostComment" runat="server" href="admincomment.aspx"><img src="Images/bubble-chat.png"/>Most Comment Ideas</a></div>
            <div class="dropdown">
            ...
            <div class="panel-body">
                <div class="media-block">
                    ...
                    <div class="dropdown media-right">  
                        <button class="btn btn-default dropdown-toggle" id="optionButton" type="button" data-toggle="dropdown">&#8226;&#8226;&#8226;</button>
